...
var vegetables = ['carrots', 'lettuce', 'radishes', 'cucumbers', 'spinach'];
...
// different fruits.
var fruits = ['strawberries', 'blueberries', 'apples', 'grapes', 'bananas', 'oranges', 'cherries'];
